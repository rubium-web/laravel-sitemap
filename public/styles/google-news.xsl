...
.url:hover
{
  ...
  <body>
	<div id="content">
		...
		<p class="expl">Generated by <a href="https://gitlab.com/Rubium/Sitemap" target="_blank" title="Sitemap generator for Laravel">Rubium-sitemap</a>. This is styled xml sitemap (for Google News), sorted by update date.</p>
