...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jquery.tablesorter/2.17.8/js/jquery.tablesorter.min.js"></script>
...
.url:hover
{
  ...
  <body>
	<div id="content">
		...
		<p class="expl">Generated by <a href="https://github.com/rubium-web/laravel-sitemap/" target="_blank" title="Sitemap generator for Laravel">laravel-sitemap</a>. This is styled xml sitemap (for Google News), sorted by update date.</p>
