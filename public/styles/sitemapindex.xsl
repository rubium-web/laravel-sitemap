...
.url:hover
{
  ...
  <body>
	<div id="content">
		...
		<p class="expl">Generated by <a href="https://github.com/rubium-web/laravel-sitemap" target="_blank" title="LaravelSitemap generator for Laravel">laravel-sitemap</a>. This is styled xml sitemapindex, sorted by update date.</p>
